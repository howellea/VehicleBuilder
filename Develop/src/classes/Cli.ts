      ...
      .then((answers) => {
        // TODO: check if the selected vehicle is the truck
          ...
          if (this.selectedVehicleVin === truck.vin) {
            ...
            this.selectedVehicleVin = answers.selectedVehicleVin;
          console.log(`Towing vehicle: ${answers.selectedVehicleVin}`);
          this.performActions
        // Perform actions to tow the selected vehicle
  ...
  performActions(): void {
    inquirer
      .prompt([
        {
          ...
          choices: [
            ...
            'Selected truck', // add selected truck
            'wheelie action', // add motorbike only action
            'Exit',
          ],
        },
      ])
      .then((answers) => {
        ...
        } else if (answers.action === 'Selected truck' ) {
       ...
       } else if (answers.action === 'wheelie action') {
